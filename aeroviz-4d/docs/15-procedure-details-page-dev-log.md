...
The `refactor_vis` branch protected-geometry, procedure visualization, annotation, and display-level work has been split into:

- `docs/18-refactor-vis-branch-dev-log.md`
