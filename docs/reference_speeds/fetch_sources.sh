...
# Be aware this pulls ~160 MB of PDFs plus 41 small HTML pages.
#
...
for f in 737NG_REV_C.pdf 737CL_REV_E.pdf 737MAX_RevK.pdf 757_Rev_H.pdf 767_REV_K.pdf \
         777-200-200ER-300_Rev_E.pdf 777-200LR-300ER-F_Rev_G.pdf 787_ACAP_Rev_Q.pdf; do
    get "boeing/$f" "$BO/$f"
done
...
get textron/citation_ascend_product_card.pdf "$TX/citation/citation_ascend_product_card.pdf"
