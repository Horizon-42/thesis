...
def _roster_eligible_keys(roster_path: Path, roster: dict[str, Any]) -> list[str]:
    ...
    from ts_transformer.data.lateral_eligibility import (  # local import keeps the loader policy-agnostic
        LATERAL_PASS_POLICY,
...
def checkpoint_data_provenance(
    ...
    """
    from ts_transformer.data.lateral_eligibility import default_lateral_pass_roster_path  # policy module; kept off this module's import graph
