...
| L3.d 速度下限 hook（只预测） | **预注册（2026-09-08 晚，代码已合并）**：`barrier+speed-floor` 组合 hook 在 L3_cta 上 0/+30/+60/+90 s，问延时能否在包线内吸收 | `l3d_speed_floor_arms.json` | 失速样本 −90 % ∧ +60 s 可飞 ≥ 88 % ∧ 横向同 L3.c；见 §六 L3.c 末 |
