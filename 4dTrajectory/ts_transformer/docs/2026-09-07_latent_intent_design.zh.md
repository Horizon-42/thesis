...
偏移 0 完全可飞 8.3 → **45.4 %**、+30 s 0.3 → 21.2 %、+60 s 0 → **2.4 %**、+90 s 0.1 %；失速样本反增 94–139 %（+60 s：67.0 万 → 13.5 万...
即 66,980 → 134,977）；新出现 `thrust_over_max`（+0：97,929，+60：113,254 个样本；此前为 0）；下限在 50–70 % 的步上生效、22–30 % 饱和，
