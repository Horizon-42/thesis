...
> **已被取代（2026-09-07），文件名已标 `.discard`**：方案骨架由
> `2026-09-07_latent_intent_design.zh.md` 取代（隐意图 + 操作参数解码 + 物理 rollout）。
> **本文的测量、oracle、结果与产物全部有效并被新文引用**（Phase 0、P0 几何指标、P1.a/b/c/d）；
> 失效的是 §三 的骨架、§五 P1.d 的跟踪器、§五 P3 的 K 锚查询解码器。误差预算的来源看本文。
