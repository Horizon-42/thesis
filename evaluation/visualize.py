...
<p class="note">Runway-threshold geometric verdict. LPV vertical uses the published-TCH path and the 7.5 m half-FSD threshold bound. Observed events reuse the producer-side threshold event; estimator intervals are diagnostic and evaluation does not refit ADS-B.</p>
