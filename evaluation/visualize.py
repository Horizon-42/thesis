...
<p class="note">Runway-threshold geometric verdict. Vertical uses the published-TCH path and the 22 m RNAV/RNP terminal vertical bound. This is not touchdown or landing certification. Observed events reuse the producer-side threshold event; estimator intervals are diagnostic and evaluation does not refit ADS-B.</p>
