...
<p class="note">Runway-threshold geometric verdict. LPV vertical uses the published-TCH path and the 7.5 m half-FSD threshold bound. Observed events reuse the runway-assignment fit; evaluation does not refit ADS-B.</p>
