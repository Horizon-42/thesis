...
schema v2; the LPV vertical correction retired it in favour of v4, and the
lateral-criterion consolidation retires v4 in favour of
`terminal-approach-evaluation-v5`. These are derived artifacts and must be
